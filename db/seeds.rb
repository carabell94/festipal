...
stage_glastonbury = ['Pyramid Stage', 'The Park', 'Acoustic Stage', 'Arcadia']
stage_boomtown = ["Lion's Den", 'Town Center', 'Nucleus Stage', 'RELIC']
stage_wilderness = ['Main Stage', 'The Level', 'The Jumpyard', 'The Valley']
